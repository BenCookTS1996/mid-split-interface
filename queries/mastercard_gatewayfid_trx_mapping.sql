-- MASTERCARD per-gatewayFid transaction denominator (parallels queries/gatewayfid_trx_mapping.sql).
-- Difference vs Visa: counts MASTERCARD transactions (mastercard_trx_count) rather than visa_trx_count.
-- Symmetrical 30.4167-day normalisation tied to recordDate. 9-month dynamic window from Month 0.
SELECT
  ...
  gateway_fidto_gateway.gatewayFid,
  CASE

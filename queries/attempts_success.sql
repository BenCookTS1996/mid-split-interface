...
enriched_logic AS (
  SELECT
    ...
    CASE
      ...
      WHEN transactionType = 'auth' AND paymentType = 'order' AND amount = 39 AND paymentMethod != 'paypal' THEN 'Upgrades'
      ...
      WHEN transactionType = 'captureauth' AND paymentType = 'order' AND amount = 39 AND paymentMethod = 'paypal' AND paymentProcessor = 'paypal' THEN 'Upgrades'
      WHEN transactionType = 'auth' AND paymentType = 'order' AND amount = 39 AND paymentMethod = 'paypal' AND paymentProcessor = 'chargehive' THEN 'Upgrades'
